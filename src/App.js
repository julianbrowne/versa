...
import { letters, status, hasRepeatedLetters } from './constants'
...
const getRandomAnswer = () => { 
  ...
  while(repeats) { 
    ...
    var word = answers[randomIndex];
    repeats = hasRepeatedLetters(word);
  };
              ...
              row.map((letter, colNumber) => (
                <span
                  ...
                  className={`${getCellStyles(
                    ...
                    colNumber,
                    letter
                  )} inline-flex items-center font-medium justify-center text-lg w-[12vw] h-[12vw] xs:w-12 xs:h-12 sm:w-20 sm:h-20`}
                >
                  {letter}
                </span>
              ))
